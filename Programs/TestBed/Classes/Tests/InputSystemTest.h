...
private:
    DAVA::UIButton* CreateKeyboardUIButton(DAVA::eInputControl key, DAVA::WideString text, DAVA::FTFont* font, DAVA::float32 x, DAVA::float32 y, DAVA::float32 w, DAVA::float32 h);
